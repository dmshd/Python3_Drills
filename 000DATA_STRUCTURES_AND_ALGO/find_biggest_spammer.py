...
trying to connect to the server the most. It then blocks the IP addresses using
the ufw command.
...
TODO : Evaluate the possibility of implementing a web feedback as "Your IP is
blocked, if you think this is an error, please contact us at [email]"
