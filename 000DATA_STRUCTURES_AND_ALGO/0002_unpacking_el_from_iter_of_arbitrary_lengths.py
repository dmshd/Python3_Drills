...
# a bare * when unpacking, but you could use a common throwaway variable name, such as
# _ or ign (ignored).
...
# various functional languages. For example, if you have a list, you can easily split
# it into head and tail components like this:
